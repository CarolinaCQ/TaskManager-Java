...
public interface IProjectController {
    ...
    ResponseEntity<ProjectDto> createProject(@Parameter(name = PARAMETER_PROJECT_ADD) @RequestBody @Valid ProjectDto dto);
    ...
    ResponseEntity<ProjectDto> updateProject(@Parameter(name = PARAMETER_PROJECT_UPDATE) @RequestBody @Valid ProjectDto dto, @Parameter(name = PARAMETER_ID) @PathVariable Long id);
    ...
    ResponseEntity<Void> deleteProject(@Parameter(name = PARAMETER_ID) @PathVariable Long id);
}
