...
public interface ITaskController {
    ...
    ResponseEntity<TaskGetDto> createTask(@Parameter(name = PARAMETER_TASK_ADD) @RequestBody @Valid TaskPostDto dto);
    ...
    ResponseEntity<TaskGetDto> updateTask(@Parameter(name = PARAMETER_TASK_UPDATE) @RequestBody @Valid TaskPostDto dto, @Parameter(name = PARAMETER_ID) @PathVariable Long id);
    ...
    ResponseEntity<Void> deleteTask(@Parameter(name = PARAMETER_ID) @PathVariable Long id);
}
