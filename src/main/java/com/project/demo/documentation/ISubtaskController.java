...
public interface ISubtaskController {
    ...
    ResponseEntity<SubtaskGetDto> createSubtask(@Parameter(name = PARAMETER_SUBTASK_ADD) @RequestBody @Valid SubtaskPostDto dto);
    ...
    ResponseEntity<SubtaskGetDto> updateSubtask(@Parameter(name = PARAMETER_SUBTASK_UPDATE) @RequestBody @Valid SubtaskPostDto dto, @Parameter(name = PARAMETER_ID) @PathVariable Long id);
    ...
    ResponseEntity<Void> deleteSubtask(@Parameter(name = PARAMETER_ID) @PathVariable Long id);
}
